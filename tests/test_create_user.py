...
class TestCreateUser:
    ...
    def test_create_user(self, create_user):
        assert create_user.status_code == StatusCode.OK and create_user.json()['success'] == True
    ...
    def test_create_two_identical_users(self, generate_user):
        ...
        assert response.status_code == StatusCode.FORBIDDEN and response.text == '{"success":false,"message":"User already exists"}'
    ...
    def test_create_user_without_data(self, email, password, name):
        ...
        assert response.status_code == StatusCode.FORBIDDEN and response.text == '{"success":false,"message":"Email, password and name are required fields"}'
